# -*- coding: utf-8 -*-
"""Final_Version_Marcos_MastersProject_Analysis.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1mGwPxAUNnheP8eWSRaGhOrF8ldvg2N_B
"""
...
# Load in data
ar_data_df <- read_excel("/content/TwoSamReadThreshold_ar_spiec_easi_gephi_network_graphdata.xlsx", sheet = "Analysis")
aras_data_df <- read_excel("/content/TwoSamReadThreshold_aras_spiec_easi_gephi_network_graphdata.xlsx", sheet = "Analysis")
as_data_df <- read_excel("/content/TwoSamReadThreshold_as_spiec_easi_gephi_network_graphdata.xlsx", sheet = "Analysis")
hc_data_df <- read_excel("/content/TwoSamReadThreshold_hc_spiec_easi_gephi_network_graphdata.xlsx", sheet = "Analysis")
...
# Load in data
ar_data_df <- read_excel("/content/TwoSamReadThreshold_ar_spiec_easi_gephi_network_graphdata_SeqTypeBodysiteUpdate.xlsx", sheet = "Node_Analysis")
aras_data_df <- read_excel("/content/TwoSamReadThreshold_aras_spiec_easi_gephi_network_graphdata_SeqTypeBodysiteUpdate.xlsx", sheet = "Node_Analysis")
as_data_df <- read_excel("/content/TwoSamReadThreshold_as_spiec_easi_gephi_network_graphdata_SeqTypeBodysiteUpdate.xlsx", sheet = "Node_Analysis")
hc_data_df <- read_excel("/content/TwoSamReadThreshold_hc_spiec_easi_gephi_network_graphdata_SeqTypeBodysiteUpdate.xlsx", sheet = "Node_Analysis")
...
"""## MaAsLin2 Statistical Analysis with Fixed Effect Metadata Modeling"""
...
# Setup/Aggregate data for Maaslin2 on the Phylum and Genus levels using the entire dataset
merged_maindata_df_phylum <- merged_maindata_df %>%
  group_by(Phylum) %>%
...
merged_maindata_df_genus <- merged_maindata_df %>%
  group_by(Genus) %>%
  summarise(across(where(is.numeric), sum, na.rm = TRUE)) %>%
  ungroup() %>%
...
# Setup metadata for Maaslin2
metadata_cleaned_df_setup <- metadata_cleaned_df %>%
  column_to_rownames("Sample_Name")

# Run MaAsLin2 on Phylum (Change disease reference 3 times for pairwise comparisons) HC
fit_data_phylum_hc = Maaslin2(
    input_data = merged_maindata_df_phylum,
    input_metadata = metadata_cleaned_df_setup,
    normalization = "TSS",
    transform = "LOG",
    analysis_method = "LM",
    correction = "BH",
    output = "phylum_hc",
    fixed_effects = c("disease", "body", "season", "age", "sex"),
    reference = c("disease,HC", "season,winter")
)

# Run MaAsLin2 on Phylum (Change disease reference 3 times for pairwise comparisons) AR
fit_data_phylum_ar = Maaslin2(
    input_data = merged_maindata_df_phylum,
    input_metadata = metadata_cleaned_df_setup,
    normalization = "TSS",
    transform = "LOG",
    ...
    output = "phylum_ar",
    fixed_effects = c("disease", "body", "season", "age", "sex"),
    reference = c("disease,AR", "season,winter")
)

# Run MaAsLin2 on Phylum (Change disease reference 3 times for pairwise comparisons) AS
fit_data_phylum_as = Maaslin2(
    input_data = merged_maindata_df_phylum,
    input_metadata = metadata_cleaned_df_setup,
    normalization = "TSS",
    transform = "LOG",
    ...
    output = "phylum_as",
    fixed_effects = c("disease", "body", "season", "age", "sex"),
    reference = c("disease,AS", "season,winter")
)

# Run MaAsLin2 on Genus (Change disease reference 3 times for pairwise comparisons) HC
fit_data_genus_hc = Maaslin2(
    input_data = merged_maindata_df_genus,
    input_metadata = metadata_cleaned_df_setup,
    normalization = "TSS",
    transform = "LOG",
    analysis_method = "LM",
...
# Run MaAsLin2 on Genus (Change disease reference 3 times for pairwise comparisons) AR
fit_data_genus_ar = Maaslin2(
    input_data = merged_maindata_df_genus,
    input_metadata = metadata_cleaned_df_setup,
    normalization = "TSS",
    transform = "LOG",
...
# Run MaAsLin2 on Genus (Change disease reference 3 times for pairwise comparisons) AS
fit_data_genus_as = Maaslin2(
    input_data = merged_maindata_df_genus,
    input_metadata = metadata_cleaned_df_setup,
    normalization = "TSS",
    transform = "LOG",
